<!-- Navbar -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="../assets/img/pengaduan.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../dashboard/dashboard_admin.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="../dashboard/logout.php" class="nav-link">
              <ion-icon name="log-out-outline" class="fs-3" style="margin-bottom: -7px;"></ion-icon>
              <p>
                Keluar
              </p>
            </a>
